//Parte 2 - sistema de estoque com código automático
package parte2;
...
public class Main {
    public static void main(String[] args) {
        ...
        produto2.inserir("Arroz", 100, "Comida", 15.90);
        
        Produto produto3 = new Produto("Sabão em pó", 30);
        produto3.inserir("Sabão em pó", 30, "Limpeza", 12.75);
        
        Produto produto4 = new Produto("Quebra-cabeça", 40, "Jogo", 18.50);
        
        int sair = 0;
        
        System.out.println("=== SISTEMA DE ESTOQUE (CÓDIGO AUTOMÁTICO) ===");
        while (sair == 0) {
